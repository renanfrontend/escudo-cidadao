...
export const Footer = () => {
  ...
  const whatsappLink = `https://wa.me/5511965781243?text=${whatsappMessage}`; // Lembre de por seu número real aqui depois
    ...
    <Box component="footer" sx={{ mt: 'auto', pt: 6, pb: 2 }}>
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <IconButton href="https://github.com/renanfrontend" target="_blank" color="inherit" size="small" sx={{ color: 'text.secondary', '&:hover': { color: '#fff', bgcolor: 'rgba(255,255,255,0.08)' } }}>
            <GitHub fontSize="small" />
          </IconButton>
          <IconButton href="https://linkedin.com/in/renan-augusto-santos" target="_blank" color="inherit" size="small" sx={{ color: 'text.secondary', '&:hover': { color: '#0a66c2', bgcolor: 'rgba(10,102,194,0.1)' } }}>
            <LinkedIn fontSize="small" />
          </IconButton>
          <IconButton href="https://instagram.com/renanbrocanelli.dev" target="_blank" color="inherit" size="small" sx={{ color: 'text.secondary', '&:hover': { color: '#e1306c', bgcolor: 'rgba(225,48,108,0.1)' } }}>
